...
(function(){
  ...
  const I18N = {
    ...
    tagline:{en:"Safe, fast, and verified school dismissal",ar:"انصراف مدرسي آمن وسريع ومؤكّد"},
    nav_home:{en:"Home",ar:"الرئيسية"},
    nav_moderator:{en:"Moderator",ar:"المشرف"},
    nav_admin:{en:"Admin",ar:"المسؤول"},
    nav_parent:{en:"Guardian/Parent",ar:"ولي أمر"},
    ...
    role_parent:{en:"Guardian/Parent / Guardian/Parent2",ar:"ولي أمر"},
    ...
    land_title_hl:{en:"safe, fast & verified",ar:"آمن وسريع ومؤكّد"},
    ...
    pv_arriving:{en:"Guardian/Parent arriving",ar:"ولي أمر قادم"},
    ...
    feat3_t:{en:"Guardian/Parent & Guardian/Parent2 app",ar:"تطبيق أولياء الأمور"},
    ...
    how1_d:{en:"Guardian/Parent taps “I'm here” in the app on the way to school.",ar:"يضغط ولي أمر «أنا هنا» في التطبيق وهو في الطريق إلى المدرسة."},
    ...
    parent:{en:"Guardian/Parent",ar:"ولي أمر"},
    ...
    /* parent */
    parent_dash:{en:"Guardian/Parent Dashboard",ar:"لوحة ولي أمر"},
    ...
    scan_qr:{en:"SCAN GUARDIAN/PARENT QR",ar:"مسح رمز ولي أمر"},
    ...
    search_phone:{en:"Battery dead? Search guardian/parent phone",ar:"بطارية فارغة؟ ابحث بهاتف ولي أمر"},
    ...
    parent_branch:{en:"Guardian/Parent branch",ar:"فرع ولي أمر"},
